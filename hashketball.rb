  ...
  game_hash = {
    home: {
      ...
      players: [
        ...
        {name: "Mason Plumlee", number: 1, shoe: 19, points: 26, rebounds: 12, assists: 10, steals: 3, blocks: 8, slam_dunks: 5},
    ...
    away: {
      ...
      players: [
        ...
        {name: "Bismack Biyombo", number: 0, shoe: 16, points: 12, rebounds: 4, assists: 7, steals: 7, blocks: 5, slam_dunks: 5},
